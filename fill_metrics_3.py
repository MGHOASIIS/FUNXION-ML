...
paradigm_map = {
    ...
    2: "2. Rotator Cuff (n=25) vs No Injury (n=20)",
    3: "3. Other Injury(n=15) vs No Injury(n=20)",
    4: "4. Rotator(n=25) vs Other Injury(n=15) "
}
...
df_tpl = pd.read_excel("tempresults.xlsx")
...
for idx, tpl_row in df_tpl.iterrows():
    ...
    for paradigm_col in paradigm_map.values():        
        ...
        print("@@@@@@@@@@@@@@", idx, tpl_row["MODEL"])
        print("********heyyyyyyyyyyyy", paradigm_col, model_label)
...
output_filename = "tempresults.xlsx"
